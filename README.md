...
# Visualization
To work visualization of the prediction basis of GCN, you have to specify the configure file which was generated after training and SMILES. Output file with name of predicted classs is restored in firuge folder.
